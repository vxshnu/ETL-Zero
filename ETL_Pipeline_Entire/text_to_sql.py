...
# Example of usage if this script is run directly
if __name__ == "__main__":
    # Make sure CUDA is properly set up
    ...
    test_queries = [
        ...
        "What are the top 5 records in the database?",
        "Find all data where the id is greater than 10"
    ]
    
    # Initialize the generator
    generator = TextToSQLGenerator(model_path="Model", tokenizer_path="Model")
